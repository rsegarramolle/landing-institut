...
**Nota important**: Es pot instal·lar nativament en un servidor web amb PHP sense Docker. Si s'opta per aquesta configuració s'ha de tenir en compte que utilitza un microframework amb gestió de rutes unificades al fitxer index.php del directori públic, per poder accedir a totes les rutes disponibles de l'aplicació.
